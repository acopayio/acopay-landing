...
const ROADMAP_2026 = {
  es: {
    ...
    items: [
      ...
      "Mesa de compra: USDT → ACOPAY (1→10) en el sitio (QR y Phantom) y vía Telegram Pay",
  ...
  pt: {
    ...
    items: [
      ...
      "Mesa de compra: USDT → ACOPAY (1→10) no site (QR e Phantom) e via Telegram Pay",
  ...
  fr: {
    ...
    items: [
      ...
      "Bureau d'achat : USDT → ACOPAY (1→10) sur le site (QR et Phantom) et via Telegram Pay",
  ...
  de: {
    ...
    items: [
      ...
      "Kaufpult: USDT → ACOPAY (1→10) auf der Website (QR und Phantom) sowie über Telegram Pay",
  ...
  ru: {
    ...
    items: [
      ...
      "Стойка покупки: USDT → ACOPAY (1→10) на сайте (QR и Phantom) и через Telegram Pay",
  ...
  ar: {
    ...
    items: [
      ...
      "مكتب الشراء: USDT → ACOPAY (1→10) على الموقع (QR وPhantom) وعبر Telegram Pay",
  ...
  th: {
    ...
    items: [
      ...
      "โต๊ะซื้อ: USDT → ACOPAY (1→10) บนเว็บไซต์ (QR และ Phantom) และผ่าน Telegram Pay",
  ...
  id: {
    ...
    items: [
      ...
      "Meja beli: USDT → ACOPAY (1→10) di situs (QR dan Phantom) serta via Telegram Pay",
  ...
  hi: {
    ...
    items: [
      ...
      "खरीद डेस्क: वेबसाइट (QR और Phantom) तथा Telegram Pay पर USDT से ACOPAY (1→10)",
  ...
  uk: {
    ...
    items: [
      ...
      "Стійка купівлі: USDT → ACOPAY (1→10) на сайті (QR і Phantom) та через Telegram Pay",
  ...
  nl: {
    ...
    items: [
      ...
      "Koopdesk: USDT → ACOPAY (1→10) op de website (QR en Phantom) en via Telegram Pay",
  ...
  pl: {
    ...
    items: [
      ...
      "Biurko zakupu: USDT → ACOPAY (1→10) na stronie (QR i Phantom) oraz przez Telegram Pay",
  ...
  tr: {
    ...
    items: [
      ...
      "Satın alma masası: sitede (QR ve Phantom) ve Telegram Pay ile USDT → ACOPAY (1→10)",
  ...
  it: {
    ...
    items: [
      ...
      "Banco acquisti: USDT → ACOPAY (1→10) sul sito (QR e Phantom) e via Telegram Pay",
  ...
  ms: {
    ...
    items: [
      ...
      "Meja beli: USDT → ACOPAY (1→10) di laman (QR dan Phantom) serta melalui Telegram Pay",
