...
const ITEMS = {
  vi: [
    ...
    "Mua ACOPAY 1:1 bằng USDT trên Acopay.net và Telegram Pay",
  ...
  zh: [
    ...
    "在 Acopay.net 与 Telegram Pay 以 USDT 1:1 购买 ACOPAY",
  ...
  ja: [
    ...
    "Acopay.net と Telegram Pay で USDT 1:1 購入",
  ...
  ko: [
    ...
    "Acopay.net 및 Telegram Pay에서 USDT 1:1로 ACOPAY 구매",
  ...
  es: [
    ...
    "Comprar ACOPAY 1:1 con USDT en Acopay.net y Telegram Pay",
  ...
  fr: [
    ...
    "Acheter ACOPAY 1:1 en USDT sur Acopay.net et Telegram Pay",
  ...
  de: [
    ...
    "ACOPAY 1:1 mit USDT kaufen auf Acopay.net und Telegram Pay",
  ...
  ru: [
    ...
    "Покупка ACOPAY 1:1 за USDT на Acopay.net и в Telegram Pay",
  ...
  ar: [
    ...
    "شراء ACOPAY بنسبة 1:1 بـ USDT على Acopay.net وTelegram Pay",
  ...
  th: [
    ...
    "ซื้อ ACOPAY 1:1 ด้วย USDT บน Acopay.net และ Telegram Pay",
  ...
  hi: [
    ...
    "Acopay.net और Telegram Pay पर USDT से ACOPAY 1:1 खरीदें",
  ...
  uk: [
    ...
    "Пул ACOPAY/USDT на Raydium",
    "Купівля ACOPAY 1:1 за USDT на Acopay.net і в Telegram Pay",
  ...
  nl: [
    ...
    "Koop ACOPAY 1:1 met USDT op Acopay.net en Telegram Pay",
  ...
  pl: [
    ...
    "Kup ACOPAY 1:1 za USDT na Acopay.net i Telegram Pay",
  ...
  tr: [
    ...
    "Acopay.net ve Telegram Pay’de USDT ile ACOPAY 1:1 satın al",
  ...
  it: [
    ...
    "Acquista ACOPAY 1:1 con USDT su Acopay.net e Telegram Pay",
