  ...
  return (
    <section className="relative overflow-x-clip px-4 py-6 sm:px-6 lg:py-8">
      ...
      <div className="relative mx-auto w-full max-w-lg lg:max-w-3xl">
        {/* Compact header — no floating logo (sidebar already has brand) */}
...
function ActionTile({
  ...
  return (
    <button
      type="button"
      disabled={disabled}
      className="flex flex-col items-center gap-1.5 rounded-xl border border-[color:var(--acopay-border)] bg-[var(--acopay-surface)] px-2 py-3 text-center opacity-60 disabled:cursor-not-allowed"
    >
