...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden pb-10 pt-8 md:pb-14 md:pt-12">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,_rgba(199,242,132,0.08),_transparent_55%)]" />
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6">
        ...
        >
          <span
            className={`mt-1 h-2 w-2 shrink-0 rounded-full ${live ? "bg-[#c7f284]" : "bg-[#9ca3af]"}`}
          />
        ...
        <div className="text-center lg:text-left">
          ...
          <p className="mt-2 bg-gradient-to-r from-[#c7f284] to-[#9ee8d8] bg-clip-text text-2xl font-semibold text-transparent sm:text-3xl">
            {TOKEN.tagline}
          </p>
          <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-[#9ca3af] sm:text-lg lg:mx-0">
        ...
        <div className="orca-card mt-10 p-4 sm:p-5">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-stretch">
            <code className="flex flex-1 items-center break-all rounded-xl bg-[#0c1017] px-4 py-3.5 font-mono text-sm text-[#e5e7eb] ring-1 ring-white/[0.06]">
              {mint}
            </code>
            <button
              type="button"
