...
const enBase: PaySection = {
  ...
  or: "or",
  widgetHint: "Login widget needs BotFather domain acopay.net. Deep link always works.",
  ...
  noPhantom: "Phase 0 · Telegram wallet only",
...
export const PAY_APP_PARTIALS: Partials = {
  vi: {
    ...
    payApp: {
      ...
      or: "hoặc",
      widgetHint: "Widget cần BotFather domain acopay.net. Deep link luôn dùng được.",
      balanceLabel: "Số dư",
      tgId: "ID Telegram",
      logout: "Đăng xuất",
      ...
      noPhantom: "Phase 0 · Chỉ ví Telegram",
