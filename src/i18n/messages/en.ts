...
export const en = {
  ...
  faq: {
    ...
    q3: "How do I buy?",
    a3: "Buy on Acopay.net at /buy (1 USDT = 10 ACOPAY). You can also swap on Jupiter or Raydium — always match the mint published on Acopay.net.",
  ...
  tradePage: {
    label: "Trade",
    title: "How to buy",
    subtitle: "Fastest path: buy at /buy — 1 USDT = 10 ACOPAY. DEX swaps remain available on Raydium / Jupiter.",
    step1Title: "Buy on Acopay.net (recommended)",
    step1Desc: "Send USDT via Solana Pay QR on the Buy page — you receive ACOPAY at 1 USDT = 10 ACOPAY in your wallet.",
  ...
  download: {
    ...
    safety2: "If you create your own wallet, write the recovery phrase on paper. Nobody can restore it for you.",
  ...
  legal: {
    ...
    privacyLi1Rest:
      " — needed to quote fees, build, simulate, and broadcast transfers you request.",
