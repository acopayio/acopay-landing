...
export const en = {
  ...
  walletHome: {
    ...
    title: "ACOPAY Wallet",
    tagline: "Keys stay on your device",
    desc: "Create or import a Solana wallet, view balances, and send or receive ACOPAY, USDT, SOL, and SPL tokens. ACOPAY does not hold your recovery phrase or private keys.",
    ...
    f1Body: "You control your keys. Transfers require your signature on device.",
    ...
    s1Title: "Keys on device",
    s1Body: "Recovery phrase and private keys stay encrypted on your phone. ACOPAY cannot move funds for you.",
    s2Title: "On-device signing",
    s2Body: "Every send requires your PIN, Face ID, or biometric unlock before the transaction is signed.",
    s3Title: "No custody desk",
    s3Body: "There is no hosted wallet balance on our servers. On-chain balances are the source of truth.",
    howTitle: "How it works",
    howBody: "Three steps from install to your first transfer.",
    step1Title: "Download the app",
    step1Body: "Install Android Beta or join iOS TestFlight from the Download page.",
    step2Title: "Create or import",
    step2Body: "Generate a new Solana wallet or import an existing recovery phrase or private key.",
    step3Title: "Send & receive",
    step3Body: "Pay by @username or wallet address. View history from the chain.",
    downloadTitle: "Get ACOPAY Wallet",
    downloadBody: "Choose Android Beta, iOS TestFlight, or store channels when available.",
    downloadCta: "Go to Download",
    faqTitle: "FAQ",
    faqQ1: "Is ACOPAY Wallet non-custodial?",
    faqA1:
      "Yes. Your recovery phrase and private keys stay on your device. ACOPAY does not hold them and cannot spend your funds.",
    faqQ2: "Where are my keys stored?",
    faqA2:
      "Keys are stored encrypted on your phone. Never share your recovery phrase or private key with anyone — including support.",
    faqQ3: "Can I swap or trade inside the app?",
    faqA3:
      "No. ACOPAY Wallet focuses on send and receive. There is no in-app exchange or swap desk.",
    faqQ4: "Which platforms are supported?",
    faqA4:
      "Android (Beta APK and Google Play when approved) and iOS (TestFlight and App Store when approved).",
    faqQ5: "How do I contact support?",
    faqA5:
      "Email support@acopay.net from the Support page. Include your app version and a short description of the issue.",
  },
  markets: {
    label: "Markets",
    title: "Markets",
    subtitle: "On-chain ACOPAY transfers and public reference data. Read-only — not an exchange.",
    allPools: "All Pools",
    binance: "Spot",
    spot: "Spot",
    ...
    poolsSubtitle: "Reference data only. The ACOPAY mobile app does not include swap or trading features.",
    volShort: "Vol",
    capShort: "Cap",
    feesShort: "Fees",
    yieldShort: "Yield",
  ...
  roadmap: {
    ...
    m2026Title: "Launch",
    m2026Item0: "Non-custodial mobile wallet (Android & iOS)",
    ...
    m2029Title: "Transparency",
    m2029Item0: "Public token metadata on Solana explorers",
    m2029Alt: "3D illustration of market listing growth",
    m2030Title: "Scale",
    m2030Item0: "Multi-language app and regional support",
    m2030Item1: "Merchant and partner payment integrations",
  ...
  faq: {
    ...
    q3: "How do I get ACOPAY in my wallet?",
    a3: "Receive ACOPAY from another wallet, or create or import a wallet in the ACOPAY app. Always confirm the official mint on Acopay.net and Solscan before you trust a balance.",
    ...
    a5: "Yes. Send and receive ACOPAY between wallets using a Solana address or ACOPAY @username. The mobile app does not include an in-app exchange or swap.",
    ...
    q9: "Does the app include swap or trading?",
    a9: "No. The ACOPAY mobile app is a non-custodial wallet for send and receive. It does not provide swap, exchange, or in-app token purchase features.",
    q11: "Contact?",
    a11: "Email {email}.",
  ...
  contractPage: {
    ...
    verify3: "Only send or receive ACOPAY after confirming this mint address on Solscan or Solana Explorer.",
  ...
  launch: {
    label: "Token",
    title: "Parameters",
    subtitle: "On-chain facts for ACOPAY on Solana Mainnet.",
    contract: "Contract",
    contact: "Contact",
    status: "Status",
  ...
  support: {
    title: "Support",
    subtitle: "Help for the ACOPAY non-custodial wallet app and acopay.net.",
    intro:
      "ACOPAY is a non-custodial Solana wallet. We do not hold your recovery phrase, private keys, or funds. For technical issues with the mobile app or this website, contact us by email.",
    emailLabel: "Email support",
    emailHint: "Include your app version, device model, and a short description of the issue. Never send your recovery phrase or private key.",
    deviceTitle: "Recover access on your device",
    device1: "If you still have the app: open Settings and verify your wallet backup before uninstalling.",
    device2: "If you reinstalled: use Import wallet with your 12-word recovery phrase on a trusted device only.",
    device3: "If you lost your recovery phrase, ACOPAY cannot restore your wallet — blockchain assets may be unrecoverable.",
    relatedTitle: "Related policies",
    privacyLink: "Privacy Policy",
    termsLink: "Terms of Service",
    deleteLink: "Delete account & data",
    nonCustodialNote:
      "ACOPAY does not provide exchange, swap, or investment services in the mobile app. Keys stay on your device.",
  },
  legal: {
