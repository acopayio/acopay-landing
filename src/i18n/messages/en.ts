...
export const en = {
  ...
  roadmap: {
    ...
    m2026Title: "Launch",
    m2026Item0: "ACOPAY Token-2022 on Solana Mainnet",
    m2026Item1: "ACOPAY/USDT pool on Raydium",
    m2026Item2: "Buy ACOPAY 1:1 with USDT on Acopay.net and Telegram Pay",
    m2026Item3: "Telegram Pay — send by @username or wallet address",
    m2026Item4: "Phantom linking and Web Pay (/pay)",
