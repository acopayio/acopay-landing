...
export const en = {
  ...
  payApp: {
    ...
    historyHidePeriodConfirm:
      "Hide all {n} transfers in this period from App, Web, and Telegram? On-chain data on Solana is not deleted.",
  ...
  download: {
    ...
    subtitle:
      "Non-custodial Solana wallet. Create or import a wallet on your device, then transfer and receive ACOPAY, USDT, SOL, and other SPL tokens.",
    ...
    storeBody:
      "The Play Store listing is in preparation. Until it is published, install only the official APK from this page.",
    ...
    feat4:
      "ACOPAY transfers may use sponsored Solana network fees; other tokens use SOL from your wallet.",
