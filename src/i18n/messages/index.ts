...
const partials: Record<string, DeepPartialMessages> = {
  vi: {
    ...
    roadmap: {
      ...
      m2026Item3: "Liên kết Phantom với Telegram Pay",
      m2026Item4: "Telegram Pay dùng ví Phantom đã liên kết",
    ...
    linkWallet: {
      ...
      pasteHint:
        "📋 Sao chép dòng lệnh đã ký bên dưới, rồi dán vào @AcopayNetwork_bot trong vòng 15 phút — trước khi link hết hạn.",
  ...
  zh: {
    roadmap: {
      ...
      m2026Item3: "将 Phantom 与 Telegram Pay 关联",
      m2026Item4: "Telegram Pay 使用已关联的 Phantom 钱包",
      m2027Title: "支付应用",
  ...
  ja: {
    roadmap: {
      ...
      m2026Item3: "Phantom を Telegram Pay に連携",
      m2026Item4: "Telegram Pay は連携済み Phantom ウォレットを使用",
      m2027Title: "Payアプリ",
  ...
  ko: {
    roadmap: {
      ...
      m2026Item3: "Phantom을 Telegram Pay와 연동",
      m2026Item4: "Telegram Pay는 연동된 Phantom 지갑 사용",
      m2027Title: "Pay 앱",
  ...
  es: {
    roadmap: {
      ...
      m2026Item3: "Vincular Phantom con Telegram Pay",
      m2026Item4: "Telegram Pay usa una billetera Phantom vinculada",
      m2027Title: "App Pay",
  ...
  pt: {
    roadmap: {
      ...
      m2026Item3: "Associar Phantom ao Telegram Pay",
      m2026Item4: "Telegram Pay usa uma carteira Phantom associada",
      m2027Title: "App Pay",
  ...
  fr: {
    roadmap: {
      ...
      m2026Item3: "Lier Phantom à Telegram Pay",
      m2026Item4: "Telegram Pay utilise un portefeuille Phantom lié",
      m2027Title: "App Pay",
  ...
  de: {
    roadmap: {
      ...
      m2026Item3: "Phantom mit Telegram Pay verknüpfen",
      m2026Item4: "Telegram Pay nutzt eine verknüpfte Phantom-Wallet",
      m2027Title: "Pay-App",
  ...
  ru: {
    roadmap: {
      ...
      m2026Item3: "Связать Phantom с Telegram Pay",
      m2026Item4: "Telegram Pay использует связанный кошелёк Phantom",
  ...
  ar: {
    roadmap: {
      ...
      m2026Item3: "ربط Phantom مع Telegram Pay",
      m2026Item4: "Telegram Pay يستخدم محفظة Phantom المرتبطة",
  ...
  th: {
    roadmap: {
      ...
      m2026Item3: "เชื่อม Phantom กับ Telegram Pay",
      m2026Item4: "Telegram Pay ใช้วอลเล็ต Phantom ที่เชื่อมแล้ว",
      m2027Title: "แอป Pay",
  ...
  id: {
    roadmap: {
      ...
      m2026Item3: "Tautkan Phantom dengan Telegram Pay",
      m2026Item4: "Telegram Pay memakai dompet Phantom yang ditautkan",
  ...
  hi: {
    ...
    footer: { product: "उत्पाद", onChain: "ऑन-चेन", community: "समुदाय", rights: "सर्वाधिकार सुरक्षित।" },
