...
const partials: Record<string, DeepPartialMessages> = {
  vi: {
    ...
    about: {
      ...
      f1Title: "Thanh toán",
      f1Desc: "Chuyển và settle ví-sang-ví trên Solana với phí chuyển on-chain rõ ràng.",
      f2Title: "Giao dịch",
    ...
    otc: {
      ...
      settleNote:
        "Chúng tôi đã gửi ACOPAY về cùng ví Solana đã trả USDT (1 USDT = 1 ACOPAY). Nếu Phantom ẩn ACOPAY, hãy hiện lại trong Manage tokens.",
      buyAgain: "Mua tiếp",
